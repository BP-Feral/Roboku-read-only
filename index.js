...
> \`loop\` - turn on/off loop.
> \`contact\` - get in touch with the owner to report bugs or suggest new features!
> *We do not store any type of data from our users. If you want to check our code,*
...
**Now Playing: \`${serverQueue.songs[0].title}\`**
    ...
    return msg.channel.send("There is nothing playing.");
      ...
      msg.channel.send (
       `
       > Add me on discord \`AliexStrasza#5268\` or send me an email 
       > at\`mihai.pricob@yahoo.com\` `
	  )
  }
});
